Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/PopcornLabs/pjsip.git", :tag => "#{s.version}" }
  s.platform     = :ios, '8.0'
  s.description  = <<-DESC
...
LICENSE
  ...
  "xcconfig": {
    "HEADER_SEARCH_PATHS": "\"$(PODS_ROOT)/pjsip/build/pjproject/src/pjlib/include\" \"$(PODS_ROOT)/pjsip/build/pjproject/src/pjlib-util/include\" \"$(PODS_ROOT)/pjsip/build/pjproject/src/pjmedia/include\" \"$(PODS_ROOT)/pjsip/build/pjproject/src/pjnath/include\" \"$(PODS_ROOT)/pjsip/build/pjproject/src/pjsip/include\"",
